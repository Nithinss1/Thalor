...
import { Leaf, Gift, Heart, TreePine } from "lucide-react";
import { mockGiftItems, mockCategoryGifts } from "../data/mockData";
...
export function GiftCatalog({ onNavigate }: GiftCatalogProps) {
            ...
            <Card key={categoryGift.id} className="overflow-hidden hover:shadow-lg transition-shadow border-2 border-purple-200">
              ...
              <CardContent className="pt-0">
                ...
                <Button 
                  ...
                  onClick={() => onNavigate('send-gift', undefined, categoryGift)}
                >
                  Send Category Gift
                </Button>
              </CardContent>
            ...
            <Card key={item.id} className="overflow-hidden hover:shadow-lg transition-shadow">
              ...
              <CardContent className="pt-0">
                ...
                <Button 
                  ...
                  onClick={() => onNavigate('send-gift', item)}
                >
                  Send This Gift
                </Button>
              </CardContent>
